...
grep -q 'CPUQuotaPerSecUSec=600ms' "$device_script"
grep -q 'CPUWeight=50' "$device_script"
grep -q 'MemoryMax=16777216' "$device_script"
grep -q 'MemorySwapMax=0' "$device_script"
grep -q 'TasksMax=32' "$device_script"
