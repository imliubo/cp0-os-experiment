...
grep -q 'dumpe2fs -h /dev/mmcblk0p3' "$factory"
grep -q 'cp0-data-layout-v2' "$factory"
grep -q '660:root:cp0-audio-control' "$factory"
...
grep -q 'start_restarts.*end_restarts' "$performance"
grep -q 'continuity:\$unit' "$performance"
