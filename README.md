...
- 独立 Developer Portal 前端：团队/2FA/公钥、永久 App ID、Listing/资源/隐私、
...
- S5E/S5F 审核与发布控制纵向切片：独立 reviewer 身份、并发唯一领取、结构化决定与消息，
  以及 approved-only Release、预约/发布排队/暂停/恢复/下架；隔离 Signer 和真实 Catalog
  Publisher 仍未完成。
