...
- Submission/Review/Release 事务域核心已完成；App Registry、Submission
  ...
  邀请/移除、Portal 会话、Review 风险分级/Console、生产对象存储/GC、动态
...
| Phase 5 | 双签名、原子安装、静态 Store、OAuth、Team 角色管理、隔离扫描、独立双审和 Release/Publisher 控制纵向切片已实现 | Identity 登录/邀请/会话、Review Console、生产 HSM、搜索发现和六步真机证据 |
