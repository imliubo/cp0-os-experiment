...
- Developer Portal、Review Console 和 Store Operations 尚未实现；
- Submission/Review/Release 后端、隔离扫描、HSM signer 和 transparency log 尚未实现；
...
| Phase 5 | 双签名、原子安装和静态 Store 已实现 | 自助发布、审核后端、搜索发现和六步真机证据 |
