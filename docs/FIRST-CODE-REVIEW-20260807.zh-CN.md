...
<!-- doc-locale: zh-CN -->
> [English](FIRST-CODE-REVIEW-20260807.md) | **简体中文**
...
**验证**：`cargo +1.85.1 clippy --workspace --all-targets --locked -- -D clippy::correctness`
通过；`cargo +1.85.1 test -p cp0-audiod --locked`
10/10 通过。
