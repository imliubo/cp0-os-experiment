  ...
  return [
    {
      ...
      risk: { policyVersion: 1, tier: "elevated", reasons: ["camera-capture"] },
      category: "Productivity",
      assignee: null,
      primaryReviewer: "Maya Chen",
      packageSha: "f01c7d9a41dd...8d31",
      listingSha: "26ca5bd2408a...3b92",
      permissions: ["camera.capture", "notifications.post"],
      imports: ["cp0_camera_capture_rgb565", "cp0_post_notification", "cp0_storage_get", "cp0_storage_put"],
      checks: [
    ...
    },
    {
      ...
      permissions: ["hardware.gpio", "radio.lora"],
      imports: ["cp0_gpio_read", "cp0_lora_receive", "cp0_lora_send", "cp0_storage_put"],
      checks: [
    ...
    },
    {
      ...
      stage: "primary",
      state: "in-review",
      risk: { policyVersion: 1, tier: "standard", reasons: [] },
      category: "Utilities",
      assignee: "Liang Bo",
      packageSha: "3c3e74c451aa...0fa2",
      listingSha: "dd6703c49acc...7ed8",
      permissions: [],
      imports: ["cp0_storage_get", "cp0_storage_put"],
      checks: [
        { name: "Package integrity", status: "passed", detail: "Developer signature and 8 entries verified" },
        { name: "Capability match", status: "passed", detail: "Private storage uses baseline host calls without a permission" },
        { name: "Listing assets", status: "passed", detail: "Icon and 2 screenshots validated" },
